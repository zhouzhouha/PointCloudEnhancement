...
METHODS = [
    ...
    ("P2P-Bridge", "Denoising", "p2p_bridge_pvds_punet_selected10", "Candidate"),
    ("PathNet", "Denoising", "pathnet_chunked_selected10", "Mixed / recent denoising candidate"),
    ...
    ("PC2-PU", "Upsampling", "pc2pu_4x_chunks256_selected10", "Candidate / weak-positive geometry"),
    ("Neural Points", "Arbitrary upsampling", "neuralpoints_16x_2048_selected10", "Mixed / fixed-size domain transfer"),
